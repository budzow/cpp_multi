...
namespace student_exercise {

#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wreturn-local-addr"
static geometry::Point* getLocalPoint() {
    geometry::Point local(1.0, 2.0, 3.0);
    return &local;
}
...
static const geometry::Circle& getLocalCircle() {
    geometry::Circle c(geometry::Point(0.0, 0.0, 0.0), 5.0);
    return c;
}
#pragma GCC diagnostic pop
...
static void run() {
    ...
    {
        geometry::Point* p = getLocalPoint();
        std::cout << "A: " << p->x() << "\n";
    }

    {
        const geometry::Circle& ref = getLocalCircle();
        std::cout << "B: " << ref.radius() << "\n";
    }

    {
        geometry::Point* p = getStackArrayElement();
        std::cout << "C: " << p->y() << "\n";
    }
}
